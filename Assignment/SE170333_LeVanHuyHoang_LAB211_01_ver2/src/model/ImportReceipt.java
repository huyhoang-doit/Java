...
public class ImportReceipt extends WareHouse {
    ...
    public ImportReceipt(String code, String time, ArrayList<WarehousedProduct> listProduct, ArrayList<Integer> listQuantity) {
    ...
    public void printInforOfReceipt() {
        ...
        int total = 0;
        System.out.println("+---------------------------------------------------------------------------------------+");
        System.out.printf("|>>> IMPORT RECEIPT %-68s|\n", " ");
        ...
        for (WarehousedProduct product : listProduct) {
            ...
            System.out.printf("|%4d|%-7s|%-25s|%-15s|%-10s|%-10s|%10d|\n",
                    count, infoSP.getProductCode(), infoSP.getProductName(), infoSP.getGroup(),
                    product.getManufacturingDate(), product.getExpirationDate(),product.getQuantitySX());
            total += product.getQuantitySX();
            count++;
        }
        System.out.println("+---------------------------------------------------------------------------------------+");
